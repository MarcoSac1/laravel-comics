...
Route::get('/', function () {
    ...
    return view('pages.home', compact('socialList','dcComicsList','shopList','dcList','footerSites',));
});
...
Route::get('/comics', function () {
    ...
    return view('pages.comics', compact('socialList','dcComicsList','shopList','dcList','footerSites','data'));
});
